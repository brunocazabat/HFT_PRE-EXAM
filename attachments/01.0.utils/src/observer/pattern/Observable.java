 ...
 * static data structure to hold the obesrvers and should not be implemented.
 * <p>
 ...
 * @see     observer.pattern.Observable#notifyObservers()
 * @see     observer.pattern.Observable#notifyObservers(java.lang.Object)
 * @see     observer.pattern.Observer
 * @see     observer.pattern.Observer#update(java.util.Observable, java.lang.Object)
 * @version   1.0, 2022
 * 
 */
...
public interface Observable<E extends Enum<E>, T> {
	...
	private List<Observer<?,?>> observers() {
		List<Observer<?,?>> observers = Observers.OBSERVERS.get(this);
		if(observers == null) {
			observers = new ArrayList<Observer<?,?>>();
			Observers.OBSERVERS.put(this, observers);
		}
		return observers;
	}
     ...
     * @see     observer.pattern.Observer#update(E aspect, T data)
     */
